...
--
-- Host: localhost
-- Waktu pembuatan: 26 Feb 2024 pada 11.14
...
(5, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin@gmail.com', 'admin', '-', 1),
(6, 'petugas', 'afb91ef692fd08c445e8cb1bab2ccf9c', 'petugas@gmail.com', 'petugas', '-', 2),
(7, 'peminjam', '55f3894bc5fc71fead8412d321c2952c', 'peminjam@gmail.com', 'peminjam', '- ', 3),
(8, 'tamu', 'f8829935a87192f3f9fab79856122c0f', 'tamu@gmail.com', 'tamu', '-', 4);
...
ALTER TABLE `kategoribuku_relasi`
  ...
  ADD KEY `KategoriBukuID_2` (`KategoriBukuID`);
...
ALTER TABLE `peminjaman`
  ...
  ADD KEY `PeminjamanID_2` (`PeminjamanID`),
...
ALTER TABLE `user`
  ...
  ADD KEY `UserID_6` (`UserID`),
  ADD KEY `UserID_7` (`UserID`),
  ADD KEY `UserID_8` (`UserID`),
  ADD KEY `UserID_9` (`UserID`),
...
--
ALTER TABLE `kategoribuku_relasi`
  ADD CONSTRAINT `kategoribuku_relasi_ibfk_1` FOREIGN KEY (`KategoriBukuID`) REFERENCES `kategoribuku` (`KategoriID`) ON DELETE CASCADE ON UPDATE CASCADE;
